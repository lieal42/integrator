...
// Mon Nov 30 09:47:10 2020 by ROOT version 6.22/02
// from TTree codtree/
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nPU;
   Int_t           nGenPart;
   Float_t         pt_genPart[ 200 ];   //[nGenPart]
   Float_t         eta_genPart[ 200 ];   //[nGenPart]
   Float_t         phi_genPart[ 200 ];   //[nGenPart]
   Float_t         energy_genPart[ 200 ];   //[nGenPart]
   Float_t         mass_genPart[ 200 ];   //[nGenPart]
   Int_t           pdgId_genPart[ 200 ];   //[nGenPart]
   Int_t           nPhoton;
   Float_t         pt_phot[ 200 ];   //[nPhoton]
   Float_t         eta_phot[ 200 ];   //[nPhoton]
   Float_t         phi_phot[ 200 ];   //[nPhoton]
   Float_t         energy_phot[ 200 ];   //[nPhoton]
   Float_t         eRaw_phot[ 200 ];   //[nPhoton]
   Float_t         eSC_phot[ 200 ];   //[nPhoton]
   Float_t         e1x5_phot[ 200 ];   //[nPhoton]
   Float_t         e2x5_phot[ 200 ];   //[nPhoton]
   Float_t         e3x3_phot[ 200 ];   //[nPhoton]
   Float_t         e5x5_phot[ 200 ];   //[nPhoton]
   Float_t         maxEnergyXtal_phot[ 200 ];   //[nPhoton]
   Float_t         sigmaEtaEta_phot[ 200 ];   //[nPhoton]
   Float_t         sigmaIetaIeta_phot[ 200 ];   //[nPhoton]
   Float_t         r1x5_phot[ 200 ];   //[nPhoton]
   Float_t         r2x5_phot[ 200 ];   //[nPhoton]
   Float_t         r9_phot[ 200 ];   //[nPhoton]
   Float_t         hOverE_phot[ 200 ];   //[nPhoton]
   Float_t         hTowOverE_phot[ 200 ];   //[nPhoton]
   Float_t         ecalRecHitSumEtConeDR04_phot[ 200 ];   //[nPhoton]
   Float_t         hcalTowerSumEtConeDR04_phot[ 200 ];   //[nPhoton]
   Float_t         hcalTowerSumEtBcConeDR04_phot[ 200 ];   //[nPhoton]
   Float_t         trkSumPtSolidConeDR04_phot[ 200 ];   //[nPhoton]
   Float_t         trkSumPtHollowConeDR04_phot[ 200 ];   //[nPhoton]
   Int_t           nTrkSolidConeDR04_phot[ 200 ];   //[nPhoton]
   Int_t           nTrkHollowConeDR04_phot[ 200 ];   //[nPhoton]
   Float_t         ecalRecHitSumEtConeDR03_phot[ 200 ];   //[nPhoton]
   Float_t         hcalTowerSumEtConeDR03_phot[ 200 ];   //[nPhoton]
   Float_t         hcalTowerSumEtBcConeDR03_phot[ 200 ];   //[nPhoton]
   Float_t         trkSumPtSolidConeDR03_phot[ 200 ];   //[nPhoton]
   Float_t         trkSumPtHollowConeDR03_phot[ 200 ];   //[nPhoton]
   Int_t           nTrkSolidConeDR03_phot[ 200 ];   //[nPhoton]
   Int_t           nTrkHollowConeDR03_phot[ 200 ];   //[nPhoton]
   Float_t         chIsoPF_phot[ 200 ];   //[nPhoton]
   Float_t         nhIsoPF_phot[ 200 ];   //[nPhoton]
   Float_t         phIsoPF_phot[ 200 ];   //[nPhoton]
   Bool_t          hasPixelSeed_phot[ 200 ];   //[nPhoton]
   Int_t           nEcalRecHit;
   Int_t           iPhi_ecalRecHit[ 2955 ];   //[nEcalRecHit]
   Int_t           iEta_ecalRecHit[ 2955 ];   //[nEcalRecHit]
   Float_t         energy_ecalRecHit[ 2955 ];   //[nEcalRecHit]
   Int_t           nPFCand;
   Float_t         pt_pfCand[ 883 ];   //[nPFCand]
   Float_t         eta_pfCand[ 883 ];   //[nPFCand]
   Float_t         phi_pfCand[ 883 ];   //[nPFCand]
   Float_t         energy_pfCand[ 883 ];   //[nPFCand]
   Float_t         mass_pfCand[ 883 ];   //[nPFCand]
   Int_t           pdgId_pfCand[ 883 ];   //[nPFCand]
   Int_t           nCaloTower;
   Float_t         pt_caloTower[ 1717 ];   //[nCaloTower]
   Float_t         eta_caloTower[ 1717 ];   //[nCaloTower]
   Float_t         phi_caloTower[ 1717 ];   //[nCaloTower]
   Float_t         mass_caloTower[ 1717 ];   //[nCaloTower]
   Float_t         energy_caloTower[ 1717 ];   //[nCaloTower]
   Float_t         emEnergy_caloTower[ 1717 ];   //[nCaloTower]
   Float_t         hadEnergy_caloTower[ 1717 ];   //[nCaloTower]
   Float_t         outerEnergy_caloTower[ 1717 ];   //[nCaloTower]
...
Analysis::Analysis(TTree* tree) : fChain(0) {
   ...
   if (tree == 0) {
      TFile* f = (TFile*)gROOT->GetListOfFiles()->FindObject("codTree_QCD_Pt_1400to1800.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("codTree_QCD_Pt_1400to1800.root");
      }
      TDirectory* dir = (TDirectory*)f->Get("codTree_QCD_Pt_1400to1800.root:/codana");
      dir->GetObject("codtree", tree);
